...
export default function Settings({ show, setShow }: UserSearchProps) {
            ...
            <div className="flex-1 flex flex-col items-center justify-center w-full h-full bg-gradient-radial to-[#08fbff] from-[#0076ff]">
              <div className="flex flex-row w-full h-full">
                <div className="flex flex-col h-full flex-1">
                  <div className="flex flex-row w-full h-full">
                    <div className="flex justify-center items-end flex-col h-full flex-1">
                      <h1 className="flex-1 flex items-center text-xl">
                        Autosave:
                      </h1>
                      <h1 className="flex-1 flex items-center text-xl">
                        Autosave:
                    ...
                    <div className="flex justify-center items-center flex-col h-full flex-1">
                      <h1 className="flex-1 flex items-center text-xl">
                        Autosave:
                      </h1>
                      <h1 className="flex-1 flex items-center text-xl">
                ...
                <div className="flex flex-col h-full flex-1">
                  <div className="flex flex-row w-full h-full">
                    <div className="flex justify-center items-center flex-col h-full flex-1"></div>
                    <div className="flex justify-center items-center flex-col h-full flex-1"></div>
                  </div>
                </div>
              </div>
